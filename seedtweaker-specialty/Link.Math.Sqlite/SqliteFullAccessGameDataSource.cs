// -----------------------------------------------------------------------
// <copyright file = "SqliteFullAccessGameDataSource.cs" company = "IGT">
...
namespace Link.Math.Sqlite
{
    ...
    /// <summary>
    ///     Create a full access SqLite connection to a
    ///     <see cref="IGameDataSource"/>.
    /// </summary>
    public class SqliteFullAccessGameDataSource :
        IConnectableGameDataSource<DbConnection>
    {
        ...
        /// </exception>
        public SqliteFullAccessGameDataSource(
